...
<%
  ...
  String sbj = name+"님이 보내신 문의입니다.";
  String sf =  "rustywhite@naver.com";   // 보내는 사람(인증 정보와 동일한 email 주소여야 함!!) 
  String sMsg = content;
  try{
        ...
        Session mailSession = Session.getInstance(p,
                new javax.mail.Authenticator() {
                  protected PasswordAuthentication getPasswordAuthentication() {
                    return new PasswordAuthentication("rustywhite","skfnro1");    // 네이버 메일 ID / PWD
                  }
                });
  ...
  System.out.println(sf+"가"+st+"에게 메일 전송 완료!");
  out.clear(); 
%>
